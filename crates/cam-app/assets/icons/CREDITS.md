...
Drawn for this project in the same flat 24×24 style (grey `#e0e0e0` with cyan
`#4cc9f0` accents). © OpenCAMStudio contributors, GPL-3.0.

- `pocket.svg` — Pocket operation
- `drill.svg` — Drill operation
